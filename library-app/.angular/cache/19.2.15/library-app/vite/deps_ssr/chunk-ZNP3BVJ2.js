...
import {
  ...
  renderApplication,
  renderModule,
} from './chunk-HUKM42NM.js';
import { ROUTES, Router, loadChildren } from './chunk-EDYRIREG.js';
import { APP_BASE_HREF, PlatformLocation } from './chunk-4TWIPHE5.js';
import {
  ApplicationRef,
  Compiler,
  Console,
...
function isHexadecimalCharacter$1(code) {
  return (
    (code >= CharCodes$2.UPPER_A && code <= CharCodes$2.UPPER_F) ||
    (code >= CharCodes$2.LOWER_A && code <= CharCodes$2.LOWER_F)
  );
}
function isAsciiAlphaNumeric$1(code) {
  return (
    (code >= CharCodes$2.UPPER_A && code <= CharCodes$2.UPPER_Z) ||
...
var EntityDecoder$1 = class EntityDecoder {
  ...
  stateNamedEntity(str, offset) {
    ...
    for (; offset < str.length; offset++, this.excess++) {
      const char = str.charCodeAt(offset);
      this.treeIndex = determineBranch$1(
        decodeTree,
        current,
  ...
  emitNamedEntityData(result2, valueLength, consumed) {
    ...
    this.emitCodePoint(
      valueLength === 1
        ? decodeTree[result2] & ~BinTrieFlags$1.VALUE_LENGTH
    ...
    switch (this.state) {
      case EntityDecoderState$1.NamedEntity: {
        return this.result !== 0 &&
          (this.decodeMode !== DecodingMode$1.Attribute || this.result === this.treeIndex)
          ? this.emitNotTerminatedNamedEntity()
          : 0;
      }
...
var attributeRules = {
  ...
  start(next, data, options) {
    ...
    return (elem) => {
      var _a2;
      return (
        !!((_a2 = adapter.getAttributeValue(elem, name)) === null || _a2 === void 0
          ? void 0
  ...
  return rules.reduce(
    (previous, rule2) =>
      previous === boolbase.falseFunc
        ? boolbase.falseFunc
        : compileGeneralSelector(previous, rule2, options, context, compileToken),
    (_a2 = options.rootFunc) !== null && _a2 !== void 0 ? _a2 : boolbase.trueFunc,
  );
}
  ...
  addToNumericResult(input2, start, end, base) {
    if (start !== end) {
      ...
      this.result =
        ...
        Number.parseInt(input2.substr(start, digitCount), base);
      this.consumed += digitCount;
    }
  }
  /**
  ...
  async handleRendering(request, matchedRoute, requestContext) {
    ...
    if (inlineCriticalCss) {
      ...
      if (renderMode === RenderMode.Server && typeof crypto === 'undefined') {
        console.error(
          `The global 'crypto' module is unavailable. If you are running on Node.js, please ensure you are using version 20 or later, which includes built-in support for the Web Crypto module.`,
        );
      }
      if (renderMode === RenderMode.Server && typeof crypto !== 'undefined') {
...
//# sourceMappingURL=chunk-ZNP3BVJ2.js.map
