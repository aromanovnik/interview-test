    ...
    if (isValueProvider(provider)) {
      ...
      factory = (_, flags) =>
        ɵɵinject(
          ...
          flags !== void 0 && flags & InjectFlags.Optional ? InjectFlags.Optional : void 0,
        );
    } else {
      const classRef = resolveForwardRef(provider && (provider.useClass || provider.provide));
...
var ApplicationRef = class _ApplicationRef {
   ...
   */
  isStable = inject(PendingTasksInternal).hasPendingTasks.pipe(
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-3YQWN6ZM.js.map
