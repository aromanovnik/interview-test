...
import { Title } from './chunk-NTGPTL2B.js';
import {
  DOCUMENT,
...
var Recognizer = class {
  ...
  processSegmentGroup(injector, config, segmentGroup, outlet, parentRoute) {
    ...
    return this.processSegment(
      ...
      true,
      parentRoute,
    ).pipe((0, import_operators.map)((child) => (child instanceof TreeNode ? [child] : [])));
  }
  /**
...
function recognize(
  ...
  return (0, import_operators.mergeMap)((t) =>
    recognize$1(
      ...
      (0, import_operators.map)(({ state: targetSnapshot, tree: urlAfterRedirects }) => {
      ...
      (0, import_operators.switchMap)((overallTransitionState) => {
        ...
        return (0, import_rxjs.of)(overallTransitionState).pipe(
          ...
          switchTap((t) => {
            ...
            return (0, import_rxjs.combineLatest)(loadComponents(t.targetSnapshot.root)).pipe(
              (0, import_operators.defaultIfEmpty)(null),
              (0, import_operators.take)(1),
            );
          }),
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-EDYRIREG.js.map
