      ...
      origin: {
        get: function () {
          ...
          var originForPort = function (defaultPort) {
            ...
            return (
              origin[0] + '://' + origin[1] + (origin[2] === defaultPort ? '' : ':' + origin[2])
            );
          };
          switch (url.scheme) {
            case 'ftp':
  ...
  'external/npm/node_modules/domino/lib/DocumentType.js'(exports, module) {
    ...
    DocumentType.prototype = Object.create(Leaf.prototype, {
      ...
      isEqual: {
        value: function isEqual(n) {
          return (
            this.name === n.name && this.publicId === n.publicId && this.systemId === n.systemId
          );
        },
      },
    });
...
var ServerXhr = class _ServerXhr {
  ...
  async ɵloadImpl() {
    if (!this.xhrImpl) {
      const { default: xhr } = await import('./xhr2-ZIACK3JJ.js');
      this.xhrImpl = xhr;
    }
  }
  build() {
...
var TRANSFER_STATE_SERIALIZED_FOR_APPID = new InjectionToken(
...
@angular/platform-server/fesm2022/platform-server.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-HUKM42NM.js.map
