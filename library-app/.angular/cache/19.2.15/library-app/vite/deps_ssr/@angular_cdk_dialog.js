...
var DomPortalOutlet = class extends BasePortalOutlet {
  ...
  constructor(
    outletElement,
    _unusedComponentFactoryResolver,
    _appRef,
    _defaultInjector,
    _document,
  ) {
  ...
  _registerGlobalListeners(elementInfo) {
    ...
    if (++this._monitoredElementCount === 1) {
      ...
      this._inputModalityDetector.modalityDetected
        .pipe((0, import_operators.takeUntil)(this._stopInputModalityDetector))
        .subscribe((modality) => {
          this._setOrigin(
            modality,
            true,
...
var BreakpointObserver = class _BreakpointObserver {
  ...
  observe(value) {
    ...
    stateObservable = (0, import_rxjs2.concat)(
      stateObservable.pipe((0, import_operators2.take)(1)),
      stateObservable.pipe((0, import_operators2.skip)(1), (0, import_operators2.debounceTime)(0)),
    );
    return stateObservable.pipe(
      (0, import_operators2.map)((breakpointStates) => {
        const response = {
          matches: false,
          breakpoints: {},
        };
  ...
  _registerQuery(query) {
    ...
    const queryObservable = new import_rxjs2.Observable((observer) => {
      ...
      (0, import_operators2.startWith)(mql),
      (0, import_operators2.map)(({ matches }) => ({
        query,
        matches,
      })),
  ...
  observe(elementOrRef) {
    ...
    return new import_rxjs3.Observable((observer) => {
      ...
      const subscription = stream
        .pipe(
          (0, import_operators3.map)((records) =>
            records.filter((record) => !shouldIgnoreRecord(record)),
          ),
          (0, import_operators3.filter)((records) => !!records.length),
        )
        .subscribe((records) => {
          this._ngZone.run(() => {
...
var CdkObserveContent = class _CdkObserveContent {
  ...
  _subscribe() {
    ...
    this._currentSubscription = (
      this.debounce ? stream.pipe((0, import_operators3.debounceTime)(this.debounce)) : stream
...
function isDataSource(value) {
  return (
    ...
    !(value instanceof import_rxjs4.ConnectableObservable)
  );
}
...
var ArrayDataSource = class extends DataSource {
  ...
  connect() {
    return (0, import_rxjs5.isObservable)(this._data)
      ? this._data
      : (0, import_rxjs5.of)(this._data);
  }
  disconnect() {}
};
...
var ScrollDispatcher = class _ScrollDispatcher {
  ...
  scrolled(auditTimeInMs = DEFAULT_SCROLL_TIME) {
    ...
    return new import_rxjs6.Observable((observer) => {
      ...
      const subscription =
        auditTimeInMs > 0
          ? this._scrolled.pipe((0, import_operators4.auditTime)(auditTimeInMs)).subscribe(observer)
  ...
  ancestorScrolled(elementOrElementRef, auditTimeInMs) {
    ...
    return this.scrolled(auditTimeInMs).pipe(
      (0, import_operators4.filter)((target) => !target || ancestors.indexOf(target) > -1),
    );
  }
...
var ViewportRuler = class _ViewportRuler {
  ...
  change(throttleTime = DEFAULT_RESIZE_TIME) {
    return throttleTime > 0
      ? this._change.pipe((0, import_operators4.auditTime)(throttleTime))
      : this._change;
  }
  /** Use defaultView of injected document if available or fallback to global window reference */
  _getWindow() {
...
var SCROLL_SCHEDULER =
  typeof requestAnimationFrame !== 'undefined'
    ? import_rxjs6.animationFrameScheduler
    : import_rxjs6.asapScheduler;
var CdkVirtualScrollViewport = class _CdkVirtualScrollViewport extends CdkVirtualScrollable {
  ...
  scrolledIndexChange = new import_rxjs6.Observable((observer) =>
  ...
  attach(forOf) {
    ...
    this.ngZone.runOutsideAngular(() => {
      ...
      this._forOf.dataStream
        .pipe((0, import_operators4.takeUntil)(this._detachedSubject))
        .subscribe((data) => {
...
var CdkVirtualForOf = class _CdkVirtualForOf {
  ...
  set cdkVirtualForOf(value) {
    ...
    if (isDataSource(value)) {
      ...
      this._dataSourceChanges.next(
        new ArrayDataSource(
          (0, import_rxjs6.isObservable)(value) ? value : Array.from(value || []),
        ),
      );
    }
  }
  ...
  constructor() {
    ...
    this._viewport.renderedRangeStream
      .pipe((0, import_operators4.takeUntil)(this._destroyed))
      .subscribe((range) => {
...
var CloseScrollStrategy = class {
  ...
  enable() {
    ...
    const stream = this._scrollDispatcher.scrolled(0).pipe(
      (0, import_operators5.filter)((scrollable) => {
        return (
          !scrollable ||
      ...
      const subscription = this._renders
        .pipe(
          (0, import_operators5.takeUntil)(
            (0, import_rxjs7.merge)(this._attachments, this._detachments),
          ),
        )
        .subscribe(() => {
  ...
  attachOverlay() {
    ...
    if (this.positionChange.observers.length > 0) {
      this._positionSubscription = this._position.positionChanges
        .pipe((0, import_operators5.takeWhile)(() => this.positionChange.observers.length > 0))
        .subscribe((position) => {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    hostBindings: function CdkDialogContainer_HostBindings(rf, ctx) {
      if (rf & 2) {
        ...
        )('aria-labelledby', ctx._config.ariaLabel ? null : ctx._ariaLabelledByQueue[0])(
          'aria-label',
          ctx._config.ariaLabel,
        )('aria-describedby', ctx._config.ariaDescribedBy || null);
      }
    },
    features: [ɵɵInheritDefinitionFeature],
    decls: 1,
...
var Dialog = class _Dialog {
   ...
   */
  afterAllClosed = (0, import_rxjs8.defer)(() =>
    this.openDialogs.length
      ? this._getAfterAllClosed()
      : this._getAfterAllClosed().pipe((0, import_operators6.startWith)(void 0)),
  );
  constructor() {}
